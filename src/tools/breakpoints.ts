...
export const definition: Tool = {
  ...
  description: 'Get key stat caps and thresholds for the loaded build: crit cap, hit chance, resistance caps (75% is standard max for each element). Call load_build first.',
